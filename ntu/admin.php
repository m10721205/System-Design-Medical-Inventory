...
<?php
 $c_categorie     = count_by_id('department');
 $c_product       = count_by_id('material_basic');
 $c_sale          = count_by_id('output_stock_recode');
         ...
         <table class="table table-striped table-bordered table-condensed">
          ...
          <tbody>
            <?php// foreach ($products_sold as  $product_sold): ?>
              <tr>
                <td><?php// echo remove_junk(first_character($product_sold['dpm_id'])); ?></td>
